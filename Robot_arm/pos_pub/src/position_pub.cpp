...
public:
  ...
  : Node("point_publisher"), flag_old(true), task_index(1)
  {
    ...
    sub_flags = this->create_subscription<std_msgs::msg::Bool>(
      ...
      task_points_[0].x = 0.1; task_points_[0].y = 0.0; task_points_[0].z = 0.12;
      task_points_[1].x = 0.1; task_points_[1].y = 0.0; task_points_[1].z = 0.08;
      task_points_[2].x = 0.1; task_points_[2].y = 0.0; task_points_[2].z = 0.12;
  }
